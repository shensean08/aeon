...
<s:textfield name="userInfoBean.address4Name" value="%{userInfoBean.address4Name}" size="10" maxlength="10" id="inp_5521" />
</div>

<div data-role="fieldcontain">
<label for="inp_5519">〒　郵便番号　（ハイフン無し入力）</label>
<s:textfield name="userInfoBean.address4Postalcode" value="%{userInfoBean.address4Postalcode}" onKeyUp="value=value.replace(/[^0-9]/g,'');AjaxZip3.zip2addr(this,'','userInfoBean.address4Address','userInfoBean.address4Address');" size="7" maxlength="7" onpaste="value=value.replace(/[^0-9]/g,'');AjaxZip3.zip2addr(this,'','userInfoBean.address4Address','userInfoBean.address4Address'" id="inp_5519" />
</div>
